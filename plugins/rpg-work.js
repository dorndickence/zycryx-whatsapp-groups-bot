...
let handler = async (m, { conn, isPrems }) => {
  ...
  let pp =
    "https://c4.wallpaperflare.com/wallpaper/991/456/22/sketch-artist-anime-anime-girls-arknights-swire-arknights-hd-wallpaper-preview.jpg";
  ...
  if (new Date() - global.db.data.users[m.sender].lastwork < 600000)
    throw `*😜 Estas cansado debes esperar ${msToTime(
      time - new Date()
...
global.work = [
  ...
  "Ayudas a moderar el grupo de DyLux por",
