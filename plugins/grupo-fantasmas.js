  ...
  switch (command) {
    case "fantasmas":
      if (total == 0)
        return conn.reply(
          m.chat,
          `*🌟 ESTE GRUPO ES ACTIVO NO TIENE FANTASMAS :D*`,
          m
        );
      m.reply(
    ...
    case "kickfantasmas":
      ...
      await m.reply(
        `*⚠️ ᴇʟɪᴍɪɴᴀᴄɪᴏɴ ᴅᴇ ɪɴᴀᴄᴛɪᴠᴏs ⚠️*\n\n*ɢʀᴜᴘᴏs: ${await conn.getName(
          m.chat
        )}*\n*ᴘᴀʀᴛɪᴄɪᴘᴀʀᴛᴇ: ${sum}*\n\n*[ 👻 ғᴀɴᴛᴀsᴍᴀs ᴇʟɪᴍɪɴᴀᴅᴏ 👻 ]*\n${sider
          .map((v) => "@" + v.replace(/@.+/, ""))
          .join(
            "\n"
          )}\n\n*ᴇʟ ʙᴏᴛ ᴇʟɪᴍɪɴᴀʀᴀ  ʟᴀ ʟɪsᴛᴀ ᴍᴇɴᴄɪᴏɴᴀᴅᴀ,  ᴇᴍᴘᴇᴢᴀᴅᴏ ᴇʟ 20 sᴇɢᴜɴᴅᴏ,  ʏ ᴄᴀᴅᴀ 10 sᴇɢᴜɴᴅᴏs ᴇʟɪᴍɪɴᴀʀᴀ  ᴜɴ ɴᴜᴍᴇʀᴏ*`,
        null,
        { mentions: sider }
      );
      await delay(1 * 10000);
